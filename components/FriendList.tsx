  ...
  return (
    <View>
      ...
      <View style={Common_styles.addFriendContainer}>
        <TextInput
          style={Common_styles.FDInput}
          placeholder="以 email 新增好友"
          placeholderTextColor="rgba(60, 130, 245, 0.5)"
          value={newFriendEmail}
          onChangeText={setNewFriendEmail}
        />
        <TouchableOpacity style={Common_styles.addButton} onPress={handleAddFriend}>
          <Text style={Common_styles.addButtonText}>新增</Text>
        </TouchableOpacity>
      </View>

      {/* 好友列表 */}
      <Text style={Common_styles.FDTitle}>目前好友列表:</Text>
      <FlatList
        data={friends}
        ...
        renderItem={({ item }) => (
          <View style={Common_styles.friendItem}>
            ...
            <TouchableOpacity style={Common_styles.delButton} onPress={() => handDelFriend(item.id)}>
              <Text style={Common_styles.delButtonText}>刪除好友</Text>
            </TouchableOpacity>
          </View>
        )}
